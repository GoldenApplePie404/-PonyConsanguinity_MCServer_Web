<?php
// MCSManager API 配置
define('MCSM_API_URL', 'https://xxx.xxxxxxx.xx/api'); // MCSManager API 地址
define('MCSM_API_KEY', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxx'); // API 密钥

// 服务器状态 API 配置
define('MCSTATUS_API_URL', 'http://mcstatus.goldenapplepie.xyz/api'); // 服务器状态 API 地址
define('MC_SERVER_IP', 'xx.xxxxxx.xx'); // 服务器 IP 地址
